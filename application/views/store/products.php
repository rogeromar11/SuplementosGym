...
<section class="section" style="padding-bottom:1.5rem;">
  <div class="container-x">
    ...
    <form class="filter-panel mt-3" method="get" action="<?php echo base_url('productos'); ?>" id="catalogFilters">
      ...
      <div style="display:flex; gap:.5rem;">
        <button type="submit" class="btn-brand btn-sm" style="flex:1;">Aplicar</button>
        <a href="<?php echo base_url('productos'); ?>" class="btn-ghost btn-sm">Limpiar</a>
      </div>
    </form>
  </div>
</section>
